...
function generateCompanionContext(soul, isFirstRun) {
  ...
  lines.push(`Streak: ${soul.streak.currentDays} days${streakMult > 1 ? ` (${streakMult.toFixed(1)}x multiplier)` : ''} | Sessions: ${soul.lifetime.sessions}`);
  ...
  lines.push('- The user can run /buddy-evolution:stats, /buddy-evolution:achievements, /buddy-evolution:dashboard, /buddy-evolution:evolve, /buddy-evolution:rename, /buddy-evolution:export, /buddy-evolution:journal for details.');
